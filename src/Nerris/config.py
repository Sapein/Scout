...
def toml_flatten(toml_config):
    ...
    return {
        ...
        "NATION": check_str(toml_config['bot']['api']['nationstates']['NATION'], 'api.nationstates.NATION'),
        "CONTACT_INFO": check_str(toml_config['bot']['api']['nationstates']['CONTACT_INFO'], "api.nationstates.CONTACT_INFO"),
        "REGION": str_to_opt_str(toml_config['bot']['api']['nationstates']['REGION']),
